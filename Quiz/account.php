...
<head>
<link rel="icon" href="emblem_library.ico" type="image/icon" sizes="16x16">
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="viewport" content="width=device-width, initial-scale=1">

<title>SPARKPLUGS</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">SPARKPLUGS</span></div>
...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="haha.php"><span class="glyphicon glyphicon-education" aria-hidden="true"></span>&nbsp;Course</a></li></ul>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Sparkplugs</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">SPARKPLUGS</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="Sparkplugs" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">SPARKPLUGS</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9704135368</h4>
		<h4 style="font-family:'typo' ">mubeen1601@gmail.com</h4>
		<h4 style="font-family:'typo' ">Muffakham Jah College of Enginnering and Technology</h4></div></div>
		</p>
      </div>
